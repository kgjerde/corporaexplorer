...
See [here](articles/bible.html) for an example of how **corporaexplorer** can be used to explore the Bible,
and [here](articles/jane_austen.html) for a starter on how to explore Jane Austen's novels.
