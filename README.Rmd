...
and returns a corpusexplorer object that can be explored in the package's two Shiny apps. The default arguments should work fine for most use cases.
...
Start the app by running the `run_corpus_explorer()` function with a corpusexplorer object created by `prepare_data()` as argument. Run the following in the R console to see documentation for the `run_corpus_explorer()` function.
...
Start the app by running the `run_document_extractor()` function with a corpusexplorer object created by `prepare_data()` as argument. Run the following in the R console to see documentation for the `run_document_extractor()` function.
