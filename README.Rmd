...
See the [Usage](https://github.com/kgjerde/corporaexplorer/blob/master/usage.md) document for more details.
...
See [here](https://github.com/kgjerde/corporaexplorer/blob/master/examples/bible.md) for an example of how **corporaexplorer** can be used to explore the Bible,
and [here](https://github.com/kgjerde/corporaexplorer/blob/master/examples/jane_austen.md) for a starter on how to explore Jane Austen's novels.
