...
**corporaexplorer**'s intended primary audience is qualitatively oriented researchers who
rely on close reading of textual documents as part of their academic activity, and for whom a typical workflow often includes analysing a set of texts downloaded from a website based on keyword search in the website's internal search engine.
...
A third, somewhat bigger (but less carefully prepared) test corpus (26,654 documents) from the same website is available [here](https://figshare.com/s/fcd93f6f93bb23be3bb1).<sup>[2](#myfootnote2)</sup>
...
Contributions in the form of feedback, code, and bug reports are most welcome.  How to contribute:
