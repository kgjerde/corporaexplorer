...
*Note March 2020: the `re2r` package has been removed ("archived") from CRAN by the CRAN maintainers*
*due to WARNINGs in the CRAN check.*
*As a result, from version 0.8.2, `corporaexplorer` uses `stringr` exclusively.*
*`re2r` will hopefully return in later versions.*
