...
* **Number of terms to chart**: How many terms (phrases/patterns) should be charted in the corpus map? Current maximum is six.
...
* **Adjust plot size**: Change plot height by adjusting the bar and clicking the
"Adjust size" button.
...
Advanced users can set the `optional_info` parameter in `explore()` to `TRUE`:
